...
\vspace{1cm}
\begin{center}
    \large\textbf{Civilingenjör med teknisk felsökningsvana och strukturerat arbetssätt. Sätter säkerhet, noggrannhet och kvalitet i första rummet. Van vid att följa rutiner, dokumentera åtgärder och agera lugnt i operativ miljö.}
\end{center}
\vspace{1cm}
\vspace{0.5em}
