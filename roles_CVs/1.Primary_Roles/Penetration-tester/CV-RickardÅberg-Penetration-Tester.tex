...
\beforetitle{
  \vspace*{-2em}
  \begin{center}
    \hspace*{1.5cm}{\color{black}\Huge\sffamily\itshape \textbf{P}enetration-\textbf{T}ester}\\[0.4em]
    \hspace*{1.5cm}{\large\sffamily Red Team \& Ethical Hacking (Junior)}
  \end{center}
  \vspace{1em}
}
%------------------%------------------%------------------%------------------%------------------
...
\input{../../__3._sections/middle_ware.tex}

\input{../../__3._sections/cybersecurity/cybersecurity_roadmap.tex}
\input{../../__3._sections/cybersecurity/redteam.tex}
\input{../../__3._sections/cybersecurity/devexperiences_security.tex}

% \section{Management by\input{../../__3._sections/cybersecurity_ethhacking.tex} Heart}
...
Negotation and Prospecting, PreSales, Coaching, TeamLead, Group psychology
...
{Independent Project}
{}
{Design and development of an iOS application integrating HRV analysis, 
breath pacing algorithms, vagal stimulation protocols and real-time biometric feedback.}
{}
...
\cventry{2025}{MUVA61 – Music Production in Practice}{Lund University}{}{}{}
\cventry{2023--Ongoing}{Toastmasters – Public Speaking}{Lund}{}{}{}
\cventry{2020}{Pedagogical Drama, Storytelling, Improvisation}{Malmö University}{}{}{}
...
Operational field work in nature conservation and forest management.
Clearing vegetation (including birch), controlled burning, and practical measures to support biodiversity and sustainable forestry.
}
...
\begin{cvcolumns}
  \cvcolumn{Managers}
      {\begin{itemize}
      \item Henrik Lundbladh, Skogsstyrelsen (Tel: +46 10-172 16 34)
      \item Jonas Paulsson, MSB IT (CyberSecurity) (Tel: +46 10-225 50 00)
      \item Julia Lawall, Assistant professor, INRIA, France
      \item Mario Sudholt,  Assistant professor, INRIA, France
      \item Mathias Hansen, Founder of Selfpoint.se 
      \end{itemize}}
\end{cvcolumns}
\footnotesize


\input{../../__3._sections/cv_section_cyber_tools.tex}
