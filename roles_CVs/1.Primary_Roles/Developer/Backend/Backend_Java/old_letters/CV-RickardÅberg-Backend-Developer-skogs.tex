...
\hspace*{0.23\linewidth} % flytta ca 10 % av sidbredden åt höger
  \begin{minipage}{\headerwidth}
    \centering
    {\HUGE\sffamily Backend Developer}\\[0.6em]
     {\LARGE\sffamily med Skogsintresse!}\\[0.6em]
...
\includegraphics[width=0.7\headerwidth]{\photoPath}\\[1.0em]
    ...
    \fbox{%
      \parbox{0.9\linewidth}{%
        ...
        \textls[400]{\textbf{Ort:}} Malmö, Sweden - och Flyttbar \\:)
      }%
    }
  \end{minipage}
  \vspace{1em}
...
\input{../../../../__3._sections/summary_backend_sv.tex}
\clearpage
...
\input{../../../../__3._sections/dev_backend_section.tex}
\clearpage
