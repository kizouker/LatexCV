...
\vspace{1cm}
\begin{center}
    \large\textbf{Junior CNC-inriktad programmerare med civilingenjörsbakgrund, van vid teknisk felsökning och strukturerat arbete, med fokus på noggrannhet, säkerhet och kvalitet.}
\end{center}
\vspace{1cm}
\vspace{0.5em}
