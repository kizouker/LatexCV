...
% Ange din bildfil
\def\@photo{../../__2._photos/rickardaberg-consultant.jpeg}
...
\usepackage{xcolor} % För färg
\usepackage{helvet} % Sans-serif (Helvetica)
\renewcommand{\familydefault}{\sfdefault} % Gör hela dokumentet sans-serif

\beforetitle{
  \vspace*{-2em} % Avstånd ovanför fotot – öka för mer luft
  \begin{center}
    \hspace*{1.5cm}{\color{black}\Huge\sffamily\itshape \textbf{D}ev\textbf{S}ec\textbf{O}ps Coach}
  \end{center}
  \vspace{1em} % Luft under rubriken
}
...
% Title - photo etc
%------------------%------------------%------------------%------------------%------------------       
%\title{DevSecOps Coach}        
\title{Agile Project Manager}
\title{MSc in Software Engineering }                   
%-\cvitem{}{
%-\begin{minipage}[t]{0.3\linewidth}
 %- \centering/
  %-\includegraphics[width=0.8\linewidth]{../../D_märke-1024x1024.png}\\
  %-\hfill
  %-\begin{minipage}[t]{0.3\linewidth}
  %-  \centering
  %-  \includegraphics[width=2.0\linewidth]{../../linkopings_universitet_logo_detail_blue.png}\\
 %- \hfill
 %- \end{minipage}
 %-\end{minipage}
%-}
...
\cvitem{}{%
  ...
  \\[0.3em]
  IKEA IT, Nordea, Ikano, Tre (Hi3G), Länsstyrelsen IT, Telenor, École des Mines, IDA Infront, Lindab, HemoCue, Hot Yoga Malmö, Radioforum, Sony
}
...
\cvitem{}{
  \begin{minipage}[t]{0.3\linewidth}
    \centering
    \includegraphics[width=1.2\linewidth]{../../__1._images/azure-fundamentals-badge.png}\\
    \scriptsize Microsoft Certified: Azure Fundamentals (AZ-900)
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.3\linewidth}
...
\section{Middlewware}
\cvlistdoubleitem{Cassandra, Spark, Hive,Reddis}{ }
...
\cvlistdoubleitem{Trauma Therapy, PTSD litterature }{Coaching, TeamLead, Group pscychlogoy}
...
Negotation and Prospecting, PreSales, Coaching, TeamLead, Group pscyc
...
\section{Todo}
%\cventry{2026 VT -- }{Jhipster}{https://www.jhipster.tech/}{Remote}{Java Jascript}{Open Source}
\cventry{2026 -- Ongoing}
{iOS App – Breathwork, HRV & Biofeedback}
{Independent Project}
{}
{Design and development of an iOS application integrating HRV analysis, breath pacing algorithms, vagal stimulation protocols and real-time biometric feedback.}
{}


  
\section{Developer experiences etc}
\cventry{2025 VT -- }{Fia Med Knuff}{https://github.com/kizouker/Fia_med_knuff.git}{Remote}{Java Jascript .Net core RabbitMQ System architectur and design}{Open Source}
...
%\cventry{Våren 2026}{Naturligt språk och Artificiell Intelligens}{Linköpings universitet}{}{}{
% Studier inom Natural Language Processing (NLP) och maskininlärning.
% Metoder för textklassificering, sekvensmodellering och semantisk analys.
% Praktiskt arbete i Python med språkdata och moderna språkmodeller.
% }
% \cventry{2026--}{Musik- och Ljuddesign}{Linnéuniversitetet}{}{}{
% Fördjupning inom ljudproduktion, inspelningsteknik och digital signalbehandling.
% Arbete i DAW-miljö (Logic Pro), mixning, arrangering och ljudestetik.
% Projektbaserat arbete med fokus på kreativ process och teknisk precision.
% }
% \cventry{2025}{MUVA61 – Musikproduktion}{Lunds universitet}{}{}{
% Universitetskurs i musikproduktion med fokus på inspelning, arrangering och mixning.
% Praktiskt arbete i Logic Pro med produktion av egna och tolkade verk.
% Fördjupning i ljudestetik, dynamikbearbetning och produktionsmetodik.
% }

\cventry{2026 VT}{Naturliga språk och AI}{Linköpings universitet}{ }{Natural Language Processing, språkmodeller, AI}{} 
\cventry{2026 VT -- 2030 (Expected)}{Master's Programme in Sound and Music Design (120 ECTS)}{Linnéuniversitetet}{Distance studies}{Audio DSP, Sound Design, Production, Digital Signal Processing}{Expected graduation: 2030}
\cventry{2025 VT}{MUVA61 – Musikproduktion i praktiken}{Lunds universitet}{ }{Akademiskt skrivande, musikproduktion, musikteori}{} 
...
\cventry{2026}{Field Officer (Fixed-term)}{Skogsstyrelsen}{Sweden}{}{
Nature conservation, field inventory, environmental monitoring and regulatory compliance within forestry operations.}
