...
\beforetitle{
  \vspace*{-2em}
  \begin{center}
    {\Huge\sffamily\bfseries Mathematics} \\[0.3em]
    {\Huge\sffamily Substitute Teacher} \\[0.4em]
    {\color{gray}\large\sffamily Pedagogical coaching -- Engineering Background} \\[1em]
...
\input{../../__3._sections/Math_teacher.tex}
...
\input{../../__3._sections/education.tex}
