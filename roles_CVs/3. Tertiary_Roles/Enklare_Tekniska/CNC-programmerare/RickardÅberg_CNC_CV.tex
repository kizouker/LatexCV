...
\usepackage{titlesec}
\graphicspath{{__1._images/}{__2._photos/}{__3._sections/}}
...
\vspace{1cm}
\begin{center}
    \large\textbf{CNC-operatör med teknisk ingenjörsbakgrund och stark vana vid strukturerat och kvalitetsinriktat arbete}
\end{center}
\vspace{1cm}
\vspace{0.5em}
...
\begin{center}
\includegraphics[width=0.78\linewidth]{g-code}
\end{center}
\vspace{-0.3em}
\end{center}
...
\begin{center}
{\Huge \textbf{Rickard Åberg}}\\[0.4em]
...
% roles_CVs/__3._sections/cv_cnc_trans.tex
\clearpage
...
\cventry{1996 --2003}{MSc in Computer Science and Engineering. 300 ECTS}{Linköping Institute of Technology}{Linköping}{}{Computer/IT-Security, 
Software production, Artificial Intelligence, Object-Oriented Programming, Functional Programming, Real time programing, L
isp/C, Advanced computer architecture, Hardware construction, Embedded development with micro-controller}  
...
\section{Employments}
\cventry{2026 Februari}{Skogsarbetare / Teammedlem}{Skogsstyrelsen}{Skåne}{}{
Fältarbete inom naturvård och skogsförvaltning. 
Arbete i team med planering, vedhantering och kontrollerad eldning enligt säkerhetsrutiner.
Ansvar för transport och logistik (Ford Transit Custom).
Bidrog till struktur i gruppkommunikation, arbetsmiljödialog och effektivitet i självorganiserande team.
}
