...
\cvlistitem{Nanodegree, Ethical Hacking@Udacity}
\cvlistitem{Ethical Hacking, Burpsuite, Kali Linux - CyberMentor@FreeCodecamp}{}
\cvlistitem{Network Fundamentals@Cisco}{}


\section{Cyber security and Cloud}
\cvlistitem{Microsoft Certified: Azure Fundamentals (AZ-900) cloud concepts, Azure core services, securituy and compliance.}
