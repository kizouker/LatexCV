...
\beforetitle{
  ...
  \begin{center}
    \hspace*{1.5cm}{\color{black}\Huge\sffamily\itshape \textbf Agile Project Manager }
  \end{center}
...
%-\begin{minipage}[t]{0.3\linewidth}
 %- \centering/
  %-\includegraphics[width=0.8\linewidth]{./images/D_märke-1024x1024.png}\\
  %-\hfill
  %-\begin{minipage}[t]{0.3\linewidth}
  %-  \centering
  %-  \includegraphics[width=2.0\linewidth]{./images/linkopings_universitet_logo_detail_blue.png}\\
 %- \hfill
 %- \end{minipage}
 %-\end{minipage}
%-}
...
\cvitem{}{
  \begin{minipage}[t]{0.3\linewidth}
    \centering
    \includegraphics[width=1.2\linewidth]{./images/azure-fundamentals-badge.png}\\
