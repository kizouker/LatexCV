...
\moderncvcolor{red}           
\usepackage{graphicx}
\graphicspath{{../photos}} % Specify the directory here
...
\cvlistdoubleitem{Java developer \\(Backend, Java 8+, spring boot, architecture, micro-services  mvn) }{React, Angular, developer\\(Front-end, ES6, npm, yarn, react, vue, redux, react native) }
\cvlistdoubleitem{Cloud/DevOps (DevOps, Jenkins CI, CA Lisa Release automation, Artifactory, Docker, Kubernetes, Ansible, AWS, Azure Devops)} {DevOps Coach (culture - value-chain) }
