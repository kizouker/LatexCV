...
\vspace{1cm}
\begin{center}
    \large\textbf{Praktiskt arbete med fokus på säkerhet och ansvar.
Trivs med fysiskt arbete utomhus, tydliga rutiner och konkreta arbetsuppgifter.}
\end{center}
\vspace{1cm}
\vspace{0.5em}
\ifxetexorluatex{}
...
\vspace{1cm}
\begin{center}
    \large\textbf{\title{Civilingenjör med inriktning mot praktiskt och fysiskt arbete}}
\end{center}
\vspace{1cm}
\vspace{0.5em}
...
\input{skogs_section.tex}
\input{section_kust.tex}
...
\section{Education}
\cventry{Höst 2025}{MUVA61 – Musikproduktion i praktiken}{Lunds universitet}{Lund}{}{Kurs med praktiskt fokus på produktion, teknik, struktur och genomförande av projekt i studiemiljö}
...
\cventry{2021-12 -- 2022-06-01 }{Erfarenhet av applikationsutveckling kopplad till apron- och markoperationer för trafikflyg, med fokus på säker parkering, positionsinformation och stöd för samordning mellan fordon och luftfartyg. Arbetet har gett förståelse för säkerhetskritiska flöden, procedurföljsamhet och lägesbild i komplex operativ miljö.}{ADBSafegate AB}{Malmö}{Fullstack Developer}{Angular, typescript, Azure, Scaled Agile Framework, SAFe}
\cventry{2021-06 -- 2021-09 }{Startup inom digital nyckelhantering för hotel}{Zaplox AB}{Lund}{Fullstack Developer}{Vue.js node javascript css AWS}
