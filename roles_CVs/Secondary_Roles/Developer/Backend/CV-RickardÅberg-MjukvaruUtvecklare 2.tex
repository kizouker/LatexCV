...
% personal data
\name{MSc C.S, Rickard}{Åberg}
%\title{``I am ...``}           
\title{FrontEnd-Developer, Back-end, Scrum master, Civ.ing}                           
...
\email{raberg@duck.com}                               % optional, remove / comment the line if not wanted
...
\makecvtitle
\section{Roles}
\cvlistdoubleitem{ Node/javscript/typescript, React, Angular, CSS, html } {Mac, Linux/Ubuntu or Windows} 
\cvlistdoubleitem{Java, Maven, SpringBoot} {Github/GitLab, GCC, C.I./C.D.}
...
\cvlistdoubleitem{React nanodegree@Udacity/Accenture }{Scrum Master}
\cvlistdoubleitem{ISEB / ISTQB  (Test)}{ICC Coach}
...
\cventry{2024 VT  }{Open Trip Planner (OTP)}{https://www.opentripplanner.org/}{}{Java}{Java21, GraphQL, python, open source}
...
\section{Education}
\cventry{2023 HT-- }{Google CyberSecurity Fundamentals}{Google/Coursera}{ }{}{} 
...
\includegraphics[scale=0.4]{../../includes/images/it-security}
\section{Courses}
