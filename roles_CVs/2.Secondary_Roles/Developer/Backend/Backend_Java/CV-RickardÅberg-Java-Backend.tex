...
%   \vspace*{-0.5em}  
%   \begin{center}
%     {\HUGE\sffamily Java Backend Developer} \\[0.4em]
%     \includegraphics[width=8.6cm]{../../../photos/rickardaberg-consultant.jpeg} \\[1em]
%     {\Huge\sffamily Rickard \textbf{\AA{}berg}} \\[1.5em]
%     {\Large\sffamily MSc in Software Engineering} \\[1em]
%    \fbox{%
...
\hspace*{0.23\linewidth} % flytta ca 10 % av sidbredden åt höger
  \begin{minipage}{\headerwidth}
    \centering
    {\HUGE\sffamily Java Backend Developer}\\[0.6em]
    % Mindre foto
    \includegraphics[width=0.7\headerwidth]{../../../photos/rickardaberg-consultant.jpeg}\\[1.0em]
...
\input{../../../__3._sections/summary_backend.tex}
...
\input{../../../__3._sections/tools_languages_processes.tex}
