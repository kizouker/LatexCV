...
{iOS/watchOS HRV Monitor}
{Personal Project}
{Malmö}
{Swift, SwiftUI, HealthKit, CoreBluetooth, Java (planned)}
{Native app for heart rate variability tracking on iPhone and Apple Watch Series 11. Integrates Apple HealthKit and Polar H10 chest strap via Bluetooth, with real-time HRV graphs. Java backend in development.}
\cventry{Spring 2025}
{Maze Game – Memory Task}
{Healthcare Research Collaboration}
{Malmö}
{React}
{Built a maze-based prototype where users memorized and reproduced paths as part of psychomotor testing, using a React frontend.}
...
{Confidential Client}
{Remote}
{React, Redux, ES6, REST APIs}
{Developed a Goodreads-style review platform enabling users to rate, review, and discover content. Implemented user authentication, search, and recommendation features, along with scalable data handling for user-generated content.}

\cventry{2019}{REST API  (Spring Boot)}{Audibook services}{}{}{
Designed and implemented a RESTful backend service using Java 11 and Spring Boot.
Explored third-party API integration for financial data access and evaluated technical constraints related to authentication and available public endpoints.
}
