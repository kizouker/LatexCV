...
\cventry{Spring 2025}{Fia Med Knuff – Distributed Game Prototype}{Personal Project}{https://github.com/kizouker/Fia_med_knuff.git}{}{
Designed and prototyped a microservice-oriented board game architecture using Java, .NET Core and RabbitMQ.
Explored messaging patterns, backend logic separation and web UI integration.
Ongoing experimental project.
}
\cventry{2023}{Test Automation Proof of Concept(Selenium WebDriver (Java))}{Personal Project}{}{}{
Developed a Proof of Concept to automate browser-based workflows using Selenium WebDriver. 
Focused on stable test design, synchronization handling, locator strategies, and maintainable architecture principles.
}
\cventry{2019}{REST API Prototype (Spring Boot)}{Personal Project}{}{}{
