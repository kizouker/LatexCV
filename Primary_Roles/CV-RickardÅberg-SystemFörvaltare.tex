...
\usepackage{graphicx}
\graphicspath{{../includes/photos}} % Specify the directory hereßΩ
...
\makecvtitle
\section{Roles}
\cvlistdoubleitem{SystemFörvaltare }{Team Lead }
\cvlistdoubleitem{SQL, Databases, Java,} {Linux, Windows}
