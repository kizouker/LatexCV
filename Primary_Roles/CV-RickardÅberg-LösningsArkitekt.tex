...
\usepackage{graphicx}
\graphicspath{{../includes/photos}} % Specify the directory here
...
\makecvtitle
\section{Roles}
\cvlistdoubleitem{LösningsArkitekt }{Team Lead }
\cvlistdoubleitem{Java developer} {React, Angular, developer}
\cvlistdoubleitem{Cloud/DevOps } {DevOps Coach}


\section{Certifications}
\cvlistdoubleitem{Microsoft Biztalk Certificate}{ISEB / ISTQB  (Test)}
\cvlistdoubleitem{Scrum Master }{ICC Coach}
\cvlistdoubleitem{React nanodegree }{}
...
\cventry{2001 HT}{Economics} {Linköping University}{Linköping}{}{Resultat- och likviditetsbudget, balansräkning, IT-juridik, kvalitet, Balanced Scorec }
...
\section{Experience}
\cventry{2022 HT  }{Hot Yoga Malmö}{hotyogamalmo.se}{Malmö}{Wordpress}{Wordpress, plugins, php, loopia}\cventry{2022 HT  }{Hot Yoga Malmö}{hotyogamalmo.se}{Malmö}{Wordpress}{Wordpress, plugins, php, loopia}
