...
% \newlength{\headerwidth} -- declared above
...
\hspace*{0.23\linewidth} % flytta ca 10 % av sidbredden åt höger
  \begin{minipage}{\headerwidth}
    ...
    {\HUGE\sffamily Backend Developer}\\[0.6em]
     {\LARGE\sffamily with interest in AI and Cybersecurity!}\\[0.6em]
 ...
 {\Huge\sffamily Rickard \textbf{\AA{}berg}}\\[1.0em]
    ...
    \fbox{%
      \parbox{0.9\linewidth}{%
        ...
        \textls[400]{\textbf{Location:}} Malmö, Sweden -- Open to relocation \\:)
      }%
    }
  \end{minipage}
  \vspace{1em}
...
% Title - photo etc
%------------------%------------------%------------------%------------------%------------------       
\title{MSc, Software Engineering (Civilingenjör D)}      
...
\input{../../../../__3._sections/summary_backend_eng.tex}
\clearpage
...
\input{../../../../__3._sections/dev_experiences_freelance.tex}
